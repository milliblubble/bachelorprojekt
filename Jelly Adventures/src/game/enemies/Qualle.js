...
function Qualle(x, y, direction, patrolBounds) {
	
	Enemy.call(this, x, y, direction,  'qualle', [0, 1], [2, 3], 150, patrolBounds, true);
}
...
Qualle.spawn = function(spawnSettings, group) {
	spawnSettings.forEach(function(settings) {
		group.add(new Qualle(settings.x * TILE_SIZE, settings.y * TILE_SIZE, settings.direction, settings.patrolBounds).sprite);
	}, this);
};

$.extend(Qualleprototype, Enemy.prototype);

module.exports = Qualle;
