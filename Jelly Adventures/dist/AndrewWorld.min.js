...
Player.prototype = {
    ...
    initializePlayerAnimations: function() {      
		...
		this.sprite.animations.add("jumpL", [10],11,true);
    ...
    update: function() {
		...
		//game.physics.arcade.overlap(this.catcher,this.enemyGroup,this.updateScore, null, this); //EINSAMMELN DER QUALLEN 
    },
...
function LandEnemy(x, y, sprite, animation, speed) {
	Enemy.call(this, x, y, sprite, animation, speed);
...
LevelOne.prototype = {
    ...
    this.scoreText = game.add.text(60 ,16, 'Score:' + this.score + '', { fontSize: '32px', fill: '#000'}); 
	...
	update: function() {
        ...
        this.score += 1;
        this.scoreText.text = 'Score: ' + this.score;   
       //this.enemyGroup.kill(); // oder qualle
